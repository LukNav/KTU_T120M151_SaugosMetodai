...
namespace ConsoleApplication.Extensions
{
    public class WinBioExtensions
    {
        ...
        public static void EnumerateDevices()
        {
            ...
            WinBioHelpers.MarshalUnmananagedArray2Struct(units_ptr, n_units, out units);
        ...
        public static void EnumerateDatabases()
        {
            ...
            if (WinBioHelpers.CheckForErrVal(ret)) { return; }
            WinBioHelpers.MarshalUnmananagedArray2Struct(databases_ptr, n_databases, out databases);
        ...
        {
            if(_identity.Type == WINBIO_IDENTITY_TYPE.WINBIO_ID_TYPE_NULL)
            {
        ...
        public static void LocateSensor()
        {
            ...
            while (WinBioHelpers.CheckForErrVal(ret))
            {
                Console.WriteLine("Locating sensor - try again...");
                ret = WinBio.Native.WinBioLocateSensor(_sessionHandle, ref _unitId);
            }
        ...
        private static void SelectBiometricSubtype()
        {
        ...
        public static void Enroll()
        {
            ...
            Console.WriteLine("Select biometric subtype - write a number:");
            SelectBiometricSubtype();
            ...
            if (ans.ToUpper() == "Y")
            {
                ...
                if (WinBioHelpers.CheckForErrVal(ret)) { return; }
                FingerprintExtensions.Add(_subtype, "");
        ...
        public static WINBIO_BIOMETRIC_SUBTYPE? Identify()
        {
        ...
        {
            return _identity.Type != WINBIO_IDENTITY_TYPE.WINBIO_ID_TYPE_NULL;
        }
        ...
        public static WINBIO_BIOMETRIC_SUBTYPE? ReadFingerprint()
        {
            Console.WriteLine("Swipe finger on a sensor");
            WINBIO_REJECT_DETAIL rejectDetail = WINBIO_REJECT_DETAIL.WINBIO_FP_SUCCESS;
            bool match = false;
        ...
        public static void DeleteCurrentTemplate()
        {
        ...
        public static void DeleteTemplate(WINBIO_BIOMETRIC_SUBTYPE fingerType)
        {
            Console.WriteLine("Deleting template...");
            uint ret = WinBio.Native.WinBioDeleteTemplate(_sessionHandle, _unitId, _identity, fingerType);
            WinBioHelpers.CheckForErrVal(ret);
        }
    }
}
